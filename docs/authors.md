...
- **Gjalt-Jorn Peters**. Author, contributor.

## Citation

Source:
[`DESCRIPTION`](https://github.com/rubenarslan/rmdpartials/blob/HEAD/DESCRIPTION)

Arslan R, Peters G (2026). *rmdpartials: Partial 'rmarkdown' Documents
to Prettify your Reports*. R package version 0.6.3,
